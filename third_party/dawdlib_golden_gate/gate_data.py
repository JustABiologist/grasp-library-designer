"""
Vendored from Fleishman-Lab/GGAssembler (dawdlib.golden_gate.gate_data).
Source: https://github.com/Fleishman-Lab/GGAssembler
License: AGPL-3.0 (see THIRD_PARTY_LICENSES.md)

Ligation fidelity algorithm based on Potapov et al. (2018) frequency matrices.
Only the fidelity/efficiency computation surface is vendored here.
"""
"""
References:
...
from . import resources as gg_resources
